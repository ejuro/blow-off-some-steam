...
A playful Omarchy Shell bar widget. Open the animated weapon wardrobe, choose one of six weapons, then spray harmless animated particles across the desktop.
...
- Hold the middle mouse button, drag toward a weapon in the hexagonal wheel, and release to switch; release near the center to cancel.
...
- Equipping any weapon spawns a roaming bullseye; hit it to dissolve it into smoke and relocate it.
- Uncheck **Target practice** in the drawer to hide targets and shoot freely.
...
The processed weapon sounds under `sounds/` are derived from the following Pixabay downloads and are used under the Pixabay Content License:
